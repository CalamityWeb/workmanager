...
VALUES (1, '@admin/', NULL, '2000-01-01 00:00:00', NULL),
       ...
       (10, '@admin/routes-management/roles/create', NULL, '2000-01-01 00:00:00', NULL),
       (11, '@admin/routes-management/roles/delete/{id}', NULL, '2000-01-01 00:00:00', NULL),
       (12, '@admin/routes-management/roles/list-all', NULL, '2000-01-01 00:00:00', NULL),
       (13, '@admin/routes-management/roles/manage/{id}', NULL, '2000-01-01 00:00:00', NULL),
       (14, '@admin/site/dashboard', NULL, '2000-01-01 00:00:00', NULL),
       (15, '@admin/site/profile', NULL, '2000-01-01 00:00:00', NULL),
       (16, '@admin/users/create', NULL, '2000-01-01 00:00:00', NULL),
       (17, '@admin/users/delete/{id}', NULL, '2000-01-01 00:00:00', NULL),
       (18, '@admin/users/list-all', NULL, '2000-01-01 00:00:00', NULL),
       (19, '@admin/users/manage/{id}', NULL, '2000-01-01 00:00:00', NULL),
       (20, '@api/', NULL, '2000-01-01 00:00:00', NULL),
       (21, '@api/routes-management/items/list', NULL, '2000-01-01 00:00:00', NULL),
       (22, '@api/routes-management/roles/list', NULL, '2000-01-01 00:00:00', NULL),
       (23, '@api/users/list', NULL, '2000-01-01 00:00:00', NULL),
       (24, '@public/', NULL, '2000-01-01 00:00:00', NULL);
...
VALUES (1, 1, '2000-01-01 00:00:00', NULL),
       ...
       (2, 20, '2000-01-01 00:00:00', NULL),
       (2, 24, '2000-01-01 00:00:00', NULL),
