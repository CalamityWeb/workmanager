...
!function (t, e) {
    ...
    const i = {}, s = t => new Promise((e => {
        ...
        }, g = t => "function" == typeof t ? t() : t, f = t => t && "function" == typeof t.toPromise,
        ...
        E = () => C(a["html-container"]), x = () => C(a.image), T = () => C(a["progress-steps"]),
        P = () => C(a["validation-message"]), L = () => v(".".concat(a.actions, " .").concat(a.confirm)),
        ...
        at = () => {
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? J(n) : X(n), R(n, e, "actions"), function (t, e, n) {
                const o = L(), i = O(), s = S();
                if (!o || !i || !s) return;
                ht(o, "confirm", n), ht(i, "deny", n), ht(s, "cancel", n), function (t, e, n, o) {
    ...
    const xt = (t, e) => {
        ...
        }, Ot = t => '<div class="'.concat(a["icon-content"], '">').concat(t, "</div>"), Mt = (t, e) => {
            const n = e.showClass || {};
        ...
        }, Ft = ["ArrowRight", "ArrowDown"], _t = ["ArrowLeft", "ArrowUp"], Rt = (t, e, n) => {
    ...
    const Zt = () => {
        ...
        }, $t = "undefined" != typeof window && !!window.GestureEvent, Jt = () => {
            const t = w();
            if (!t) return;
            let e;
            t.ontouchstart = t => {
    ...
    function oe(t) {
        t = ae(t);
        const e = Yt.swalPromiseResolve.get(this), n = ie(this);
    ...
    const re = t => {
        ...
        }, ae = t => void 0 === t ? {isConfirmed: !1, isDenied: !1, isDismissed: !0} : Object.assign({
            isConfirmed: !1,
            isDenied: !1,
            isDismissed: !1
        }, t), ce = (t, e, n) => {
        ...
        }, me = t => t.checked ? 1 : 0, he = t => t.checked ? t.value : null,
    ...
    }, we = (t, e) => !!e && e.toString() === t.toString(), ve = (t, e) => {
        const n = ft.innerParams.get(t);
    ...
    const qe = {
        ...
        _e = t => Object.prototype.hasOwnProperty.call(qe, t), Re = t => -1 !== Ve.indexOf(t), Ue = t => Ne[t],
        ze = t => {
    ...
    function Ye(t) {
        ...
        const o = Ze(t), i = Object.assign({}, n, o);
    ...
    const dn = {};
    const pn = t => {
        for (let e = t.target; e && e !== document; e = e.parentNode) for (const t in dn) {
    ...
    const In = (t, e, n) => new Promise(((o, s) => {
            ...
            Yt.swalPromiseResolve.set(t, o), Yt.swalPromiseReject.set(t, s), e.confirmButton.onclick = () => {
                ...
                Vt(t), e.toast || (t.keydownHandler = t => Rt(e, t, n), t.keydownTarget = e.keydownListenerCapture ? window : A(), t.keydownListenerCapture = e.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {capture: t.keydownListenerCapture}), t.keydownHandlerAdded = !0)
            })(i, n, r), ((t, e) => {
